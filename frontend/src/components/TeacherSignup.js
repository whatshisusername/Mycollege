...
function TeacherSignup() {
  ...
  return (
    ...
    <input className='px-3 py-2 rounded-lg bg-white text-black outline-none focus:bg-gray-50 duration-200 border border-gray-200 w-full' type='number' placeholder='Enter registration ID' value={registrationid} onChange={(e)=>{setregistrationid(e.target.value)}} required></input>
