...
function AddCourse() {
  ...
  return authStatus?(
    ...
    <input className='px-3 py-2 rounded-lg bg-white text-black outline-none focus:bg-gray-50 duration-200 border border-gray-200 w-full' type='number' placeholder='Enter Course number' value={coursenumber} onChange={(e)=>{setcoursenumber(e.target.value)}} required></input>
